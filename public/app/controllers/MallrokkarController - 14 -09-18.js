app.controller('MallrokkarController', function(dataFactory,$scope,$http){
 ...
 //alert('asdfsadf');
  ...
  function getResultsPage(pageNumber) {
      ...
      if(! $.isEmptyObject($scope.libraryTemp)){
          ...
          dataFactory.httpRequest('/angular_project/public/mallrokkar?date='+$scope.date+'&page='+pageNumber).then(function(data) {
        ...
        dataFactory.httpRequest('/angular_project/public/mallrokkar?page='+pageNumber).then(function(data) {
          	$scope.saler_rokkar = data.saler_rokkar;
		  	$scope.totalItems = data.saler_rokkar.total;
			$scope.purchaser_rokkar = data.purchaser_rokkar;
		  	$scope.totalItems1 = data.purchaser_rokkar.total;
  ...
  $scope.save123Add = function(){
    ...
    dataFactory.httpRequest('mallrokkar','POST',{purchaser:$scope.choices},$scope.form).then(function(data) {
